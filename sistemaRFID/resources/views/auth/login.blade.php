@vite('resources/css/app.css')
    <section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" style="background-image: url(https://anki-study.com/wp-content/uploads/2018/10/school_4-768x503.jpg);">
            <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            <div class="w-full px-24 z-10">
                <h1 class="text-5xl font-bold text-left tracking-wide">Sistema de Asistencias</h1>
                <p class="text-3xl my-4">Administra los datos desde un sólo lugar.</p>
            </div>
        </div>
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
            ...
            <div class="w-full py-6 z-20">
                ...
                {{-- <form method = "POST" action="{{route ('login')}}" novalidate class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto"> --}}
                    ...
                    <div class="px-4 pb-2 pt-4">
                        <button class="uppercase block w-full font-bold p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">log in</button>
                    </div>

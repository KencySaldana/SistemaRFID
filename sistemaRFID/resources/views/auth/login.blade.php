...
<section class="min-h-screen flex items-stretch text-white ">
    <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center"
        style="background-image: url(https://anki-study.com/wp-content/uploads/2018/10/school_4-768x503.jpg);">
    ...
    <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0"
        ...
        <div class="w-full py-6 z-20">
            ...
            <form method="POST" action="{{ route('login-iniciar-sesion') }}" novalidate
                ...
                @csrf
                <div class="pb-2 pt-4">
                    <input type="text" name="username" id="username" placeholder="Ingresa tu email o usuario"
                ...
                <div class="px-4 pb-2 pt-4">
                    <button
                        class="uppercase block w-full font-bold p-4 text-lg rounded-full bg-indigo-500 hover:bg-indigo-600 focus:outline-none">log
                        in</button>
                </div>
